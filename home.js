...
(function() {
  ...
  const AI_ICONS = [
    ...
    `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="gemGradHome" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse">
          <stop stop-color="#1BA1E3"/>
          <stop offset="0.5" stop-color="#9B72CF"/>
          <stop offset="1" stop-color="#D96570"/>
        </linearGradient>
      </defs>
      <path d="M12 0C12 6.627 6.627 12 0 12C6.627 12 12 17.373 12 24C12 17.373 17.373 12 24 12C17.373 12 12 6.627 12 0Z" fill="url(#gemGradHome)"/>
    </svg>`,
